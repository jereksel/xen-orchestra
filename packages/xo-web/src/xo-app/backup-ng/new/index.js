    ...
    effects: {
      createJob: () => async state => {
        ...
        await createBackupNgJob({
          ...
          name: state.name,
          proxyId: state.proxyId === null ? undefined : state.proxyId,
          schedules: mapValues(
            state.schedules,
    ...
    computed: {
      ...
      crMode: (state, { job }) =>
        state.proxyId != null
          ...
          : defined(
              state._crMode,
              () => job.mode === 'delta' && state.srs.length > 0,
              false
            ),
      disabledCrMode: state =>
        state.proxyId != null ||
        state.isFull ||
      ...
      drMode: (state, { job }) =>
        state.proxyId != null
          ...
          : defined(
              state._drMode,
              () => job.mode === 'full' && state.srs.length > 0,
              false
            ),
      disabledDrMode: state =>
        state.proxyId != null ||
        state.isDelta ||
